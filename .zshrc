...
export ZSH=/Users/tjkemper/.oh-my-zsh
...
plugins=(git kubectl docker spring golang aws knife httpie autoenv)
# npm postgres ruby docker-compose python pip virtualenv
